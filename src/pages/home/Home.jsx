        ...
        <div className="max-w-content mx-auto px-6">
          ...
          <div className="mb-10">
            ...
            <div className="flex justify-between mt-2 max-w-[640px]">
              <span className="font-sans font-medium text-xs text-slate-500 uppercase tracking-widest">Nordkapp 71°10′N</span>
              <span className="font-sans font-medium text-xs text-slate-500 uppercase tracking-widest">Lindesnes 57°58′N</span>
            </div>
          </div>
